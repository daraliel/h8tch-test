...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var Columns = __webpack_require__(163);
	var Controls = __webpack_require__(164);
	var Search = __webpack_require__(165);
	...
	var Main = React.createClass({
	  ...
	  handleOnDelete: function handleOnDelete(col, row) {
	    var updates = {};
	    var message;
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'itemAppCols' },
	        React.createElement(
	          'div',
	          { className: 'controls' },
	          React.createElement(Controls, { onNewData: this.handleNewData }),
	          React.createElement(Search, { onFilter: this.handleFilter })
	        ),
	        React.createElement(
	          'div',
	          { className: 'itemColumns' },
	          React.createElement(Columns, { onDelete: this.handleOnDelete, col1: col1, col2: col2, filter: filter })
	        )
	      )
	    );
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Columns = React.createClass({
	  ...
	  deleteRow: function deleteRow(col, row, e) {
	        ...
	        col1.map(function (row, index) {
	          return React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { className: 'delButton', onClick: function onClick(e) {
	                    return _this.deleteRow(1, row, e);
	                  } },
	                '\xD7'
	              )
	            )
	          ...
	          return React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { className: 'delButton', onClick: function onClick(e) {
	                    return _this.deleteRow(2, row, e);
	                  } },
	                '\xD7'
	              )
	            )
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { ref: 'newItem', type: 'text', placeholder: 'Enter item' }),
	        React.createElement(
	          'select',
	          { ref: 'columns' },
	          React.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Search = React.createClass({
	  ...
	  filterOut: function filterOut(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      { className: "search" },
	      "Search an item",
	      React.createElement("input", { type: "input", className: "searchBox", ref: "search", placeholder: "Search", onKeyUp: this.filterOut })
	    );
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@1,300&display=swap);", ""]);

	// module
	exports.push([module.id, "body{font-family:Helvetica,Sans-Serif;text-transform:uppercase;color:#f3f4f6;font-weight:300}div{display:inline;float:left}div.main{background-color:#78808e;width:60em;position:static;transform:translate(0, 0);margin-top:0;padding:3em}@media(min-width: 20em){div.main{width:20em}}@media(min-width: 28em){div.main{width:28em}}@media(min-width: 40em){div.main{position:absolute;top:45%;left:50%;transform:translate(-50%, -50%);width:40em;margin:2em auto 3em auto}}.main:after{content:\" \";display:block;height:0;clear:both;visibility:hidden}h1{font-family:\"Merriweather\",serif;text-transform:none;color:#fefefe}h2{background:linear-gradient(0deg, #818fa2, #b4bdc9);font-weight:500;text-align:center;padding:.25em 0}p.lorem{color:#88e0d6;text-transform:none}.itemAppCols{position:relative;width:100%}.itemAppCols:after{content:\"\";display:table;clear:both}.controls{float:left;width:50%;height:100%;min-height:300px}@media(min-width: 40em){.controls{width:33.33%}}.itemColumns{float:left;width:50%}@media(min-width: 40em){.itemColumns{width:66.66%}}.itemColumns div{width:100%}input,select,textarea,button{-ms-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;-webkit-box-sizing:border-box}input,select,textarea{text-indent:1em}input{width:inherit;height:4em;border:3px solid #f3f4f6;background-color:#9ba1ab;color:#bdc0c7;display:block}select{text-transform:uppercase;margin-top:.5em;width:100%;height:4em;cursor:pointer;border-radius:0;background-color:#9ba1ab;border:3px solid #f3f4f6;color:#bdc0c7;appearance:none;-webkit-appearance:none;-moz-appearance:none;transition:color .3s ease,background-color .3s ease,border-bottom-color .3s ease;background-image:url(\"data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' version='1.1' height='10px' width='15px'%3E%3Ctext x='0' y='10' fill='white'%3E%E2%96%BE%3C/text%3E%3C/svg%3E\");background-repeat:no-repeat;background-size:1.5EM 1EM;background-position:right center;background-clip:border-box;-moz-background-clip:border-box;-webkit-background-clip:border-box}select:hover,select:focus{color:#f3f4f6;background-color:#78808e}button{margin-top:1em;width:100%;height:4em;border:3px solid #f3f4f6;background-color:#78808e;color:#f3f4f6;text-align:center;font-weight:700}button:hover{background-color:#f3f4f6;color:#78808e;text-align:center}.searchBox{width:inherit;height:3em;background-image:url(\"https://www.iconsdb.com/icons/download/white/magnifying-glass-3-24.png\");background-repeat:no-repeat;background-position:95% 50%}.search{position:absolute;bottom:0;left:0;font-weight:700}::placeholder{text-transform:uppercase;margin-left:1em}div.column{position:relative;width:100%;height:100%;border:5px solid #fff;box-sizing:border-box}@media(min-width: 40em){div.column{width:50%}}div.row{width:100%;float:left;background-color:#f3f4f6;color:#78808e;padding:.5em 0}div.row span{margin-left:1em;font-size:14pt}.row:nth-child(odd){background-color:#78808e;color:#f3f4f6}button.delButton{width:2em;height:2em;font-size:12pt;border:2px solid #78808e;border-radius:5px;color:#78808e;text-align:center;background-color:#f3f4f6;float:right;margin:0 1em 0 0}button.delButton:hover{background-color:#78808e;color:#f3f4f6}.row:nth-child(odd) .delButton{background-color:#78808e;color:#f3f4f6;border:2px solid #f3f4f6}.row:nth-child(odd) .delButton:hover{background-color:#f3f4f6;color:#78808e}div.rowHeader{background:linear-gradient(0deg, #818fa2, #b4bdc9);font-weight:500;text-align:center;padding:.5em 0;width:100%;float:left}", ""]);
